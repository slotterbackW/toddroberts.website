    ...
    <div className="main" id="top">
      ...
      <div className="row">
        <div className="col-12">
          <img src={HoldingBoard} alt="Todd holding one of his favorite boards!" width="100%"/>
        </div>
      </div>
      <div className="row">
        <div className="col-6">
          <img src={HawaiiBoard} alt="A skateboard crafted of beautiful mahogany and maple." width="100%"/>
        </div>
        <div className="col-6">
          <img src={UmbrellaBoard} alt="Skateboard with a funny design" width="100%"/>
        </div>
      </div>
    </div>
    <Footer/>
