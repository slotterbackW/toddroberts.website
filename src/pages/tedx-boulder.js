...
const TEDxBoulder = (props) => (
  <MainLayout>
    ...
    <div className="main" id="top">
      ...
      <ul>
        <li>Music as a Visual Art: <a href="https://youtu.be/k7ngnWJ6Hks" target="_blank" rel="noopener noreferrer">https://youtu.be/k7ngnWJ6Hks</a></li>
        <li>Owning your Duality <a href="https://youtu.be/zYhgy5ouYLM" target="_blank" rel="noopener noreferrer">https://youtu.be/zYhgy5ouYLM</a></li>
        <li>Playlist of all 15 videos: <a href="https://www.youtube.com/watch?v=BR9dbjubfuU&list=PLhV8pUp3pnpcvYnuISfPKmV-orU0Q9Rms" target="_blank" rel="noopener noreferrer">https://www.youtube.com/watch?v=BR9dbjubfuU&list=PLhV8pUp3pnpcvYnuISfPKmV-orU0Q9Rms</a></li>
      </ul>
    </div>
    <Footer/>
  </MainLayout>
