  ...
  <MainLayout>
    ...
    <div className="main" id="top">
      <div className="title-container">
        ...
        <img src={OverviewImage} alt="Stomach Overview" width="100%" />
        ...
        <img src={PMotionBrainstorm} alt="Peristaltic Motion Brainstorm" width="100%" />
        ...
        <img src={BSnake} alt="Bearing Snake" width="100%" />
        ...
        <img src={FixtureGIF} alt="Straight Fixture" width="100%" />
        ...
        <img src={PMotion2} alt="2nd iteration of Peristaltic Motion" width="100%" />
        ...
        <img src={Propagation} alt="Propagation" width="100%" />
        <h2>Stomach Bug</h2>
        ...
        <img src={StomachMold} alt="Stomach Mold" width="100%" />
        ...
        <img src={JStomach} alt="J-Shaped Stomach" width="100%" />
        <h2>Conclusion</h2>
