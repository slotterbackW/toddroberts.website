...
const EnablingVideography = (props) => (
  <MainLayout>
    ...
    <div className="main" id="top">
      ...
      <p>In addition to my engineering role in the student club Enabling Engineering, I have also had the chance to use my videography skills. Last spring I filmed all of the active groups and created videos showcasing the work that they had accomplished and the end users they have helped. These videos have helped the club to spread awareness of our cause, recruit new members, and raise funds. Check out the Enabling Facebook page to view the videos I created.</p>
      <a href="https://www.facebook.com/EnablingEngineering/" target="_blank" rel="noopener noreferrer">https://www.facebook.com/EnablingEngineering/ </a>
    </div>
    <Footer/>
  </MainLayout>
)
